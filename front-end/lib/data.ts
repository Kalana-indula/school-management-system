...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2026, 2, 13, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 13, 10, 0),
    end: new Date(2026, 2, 13, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 2, 13, 11, 0),
    end: new Date(2026, 2, 13, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 13, 14, 0),
    end: new Date(2026, 2, 13, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 2, 14, 8, 0),
    end: new Date(2026, 2, 14, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 14, 10, 0),
    end: new Date(2026, 2, 14, 10, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 2, 14, 13, 0),
    end: new Date(2026, 2, 14, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 2, 14, 14, 0),
    end: new Date(2026, 2, 14, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 2, 15, 9, 0),
    end: new Date(2026, 2, 15, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 2, 15, 10, 0),
    end: new Date(2026, 2, 15, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
